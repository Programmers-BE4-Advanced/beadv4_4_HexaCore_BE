...
import com.back.chat.dto.request.ChatMessageHistoryRequestDto;
...
public class ChatController {
    ...
    @GetMapping("/history")
    public CommonResponse<ChatMessageHistoryResponseDto> getHistory(@RequestBody ChatMessageHistoryRequestDto requestDto){
        return CommonResponse.success(
                HttpStatus.OK,
                "채팅 메시지 히스토리 조회 성공",
                chatFacade.getHistory(requestDto)
        );
    }
}
